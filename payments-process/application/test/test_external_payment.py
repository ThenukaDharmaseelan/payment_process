...
def test_payment_invalid_argument():
    ...
    card_data = dict(CreditCardNumbers="1234123412341234", CardHoldewr="thenuka", SecurityCode="111", ExpirationDate="2020/1/1", Amount=222.2)
...
def test_payment_ext_invalid_credit_card_info():
    ...
    # card numbers
    card_data_1 = {"CreditCardNumber": "qwer123456ijiojw","CardHolder":"thenuka","SecurityCode": "111",
"ExpirationDate": "2020/1/1","Amount": 333.3}
    card_data_2 = {"CreditCardNumber": "1234567890123456", "CardHolder": "thenuka", "SecurityCode": "111",
...
def test_valid_input_data_for_various_amount():
    ...
    card_data_1 = {"CreditCardNumber": "1234567890123456", "CardHolder": "thenuka", "SecurityCode": "111",
                   "ExpirationDate": "2022/11/12", "Amount": 19}
    card_data_2 = {"CreditCardNumber": "1234567890123456", "CardHolder": "thenuka ", "SecurityCode": "111",
                   "ExpirationDate": "2022/11/12", "Amount": 333}
    card_data_3 = {"CreditCardNumber": "1234567890123456", "CardHolder": "thenuka ", "SecurityCode": "111",
...
def test_security_code():
    ...
    card_data_1 = {"CreditCardNumber": "qwer123456ijiojw", "CardHolder": "thenuka", "SecurityCode": "111",
                   "ExpirationDate": "2022/1/1", "Amount": 333.3}
    card_data_2 =  {"CreditCardNumber": "qwer123456ijiojw", "CardHolder": "thenuka ", "ExpirationDate": "2022/1/1", "Amount": 333.3}
    card_data_3 = {"CreditCardNumber": "qwer123456ijiojw", "CardHolder": "thenuka ", "SecurityCode": 444,
                   "ExpirationDate": "2022/1/1", "Amount": 333.3}
